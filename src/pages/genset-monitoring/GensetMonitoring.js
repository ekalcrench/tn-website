...
export default function GensetMonitoring(props) {
  const dataLengthRequest = 4;
  console.log("gensetData :", props.gensetData);

  useLayoutEffect(() => {
    props.getDataCurrentPage(props.gensetData.startRequest, dataLengthRequest);
  }, []);
      ...
      <div className="home-content">
        ...
        <div>
          ...
          <div className="table-body">
            {props.gensetData.data?.length > 0 ? (
              props.gensetData.data.map((element, index) => {
                return (
